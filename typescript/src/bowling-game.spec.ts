...
describe("bowling game", () => {
    ...
    it("scores ten normal frames", () => {
        roll(game, 1, 2, 1, 4, 1, 6, 2, 1, 2, 2, 3, 3, 2, 0, 8, 1, 1, 6, 5, 4)
    ...
    it("scores nine normal frames and a spare (+bonus roll)", () => {
        roll(game, 1, 2, 1, 4, 1, 6, 2, 1, 2, 2, 3, 3, 2, 0, 8, 1, 1, 6, 6, 4, 2)
    ...
    it("scores nine normal frames, a strike plus two bonus rolls", () => {
        roll(game, 1, 2, 1, 4, 1, 6, 2, 1, 2, 2, 3, 3, 2, 0, 8, 1, 1, 6, 10, 4, 2)
    ...
    it("scores perfect game", () => {
        roll(game, ...new Array<number>(12).fill(10))
...
function roll(game: Game, ...pinsRolls: number[]) {
